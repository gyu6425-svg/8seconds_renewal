...
export default function MenCurationMoodboard() {
    ...
    const activeSet =
        menCurationChipSets.find((chip) => chip.id === activeChip) ?? menCurationChipSets[0];
    const imageRows = [
    ...
    return (
        <section className="w-full bg-white py-[150px]">
            ...
            <div className="mx-auto w-full max-w-[1400px] px-4 md:px-0">
                ...
                {/* Moodboard Image Grid Area with Layered Text */}
                <div ref={sectionRef} className="relative">
                    ...
                    <div ref={imageGridRef} className="relative z-10 flex flex-col gap-[12px]">
                        ...
                        {/* Spacer for Typography visibility */}
