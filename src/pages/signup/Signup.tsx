      ...
      <div className="w-full max-w-[670px]">
        ...
        <form onSubmit={handleSubmit} className="mx-auto flex max-w-[558px] flex-col">
          ...
          <input
            ...
            placeholder="이메일"
            required
            className="mt-3 h-[70px] w-[558px] border border-[#999999] px-4 text-[18px] text-[#555555] outline-none transition-colors placeholder:text-[#888888] focus:border-[#111111]"
          />
